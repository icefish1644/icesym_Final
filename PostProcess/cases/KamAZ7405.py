...
injection0 = dict()
injection0['ignition_delay_model'] = 1      # Ignition delay Model 0:"Livengood and Wu", 1:"Hardenberg and Hase"
injection0['dtheta_inj'] = 0.130009575981   # Injection duration, measure in crank angle (radians)
injection0['m_inj'] = 0.0001218             # Fuel mass injected for cycle
injection0['theta_inj_ini'] = 6.0388392119  # Angle of start the injection
injection0['T_fuel'] = 300.0                # Temperature of fuel injectio
injection0['pulse'] = 1                     # Shape of the injection pulse: 0: Squared sine-wave, 1: Square wave
